package joblob.springrest.springrestdemo.repository.jdbc;
...
public class JdbcUserRepositoryImpl implements UserRepository {
    ...
    private User getByUsername(String username) {
        ...
        return this.namedParameterJdbcTemplate.queryForObject("SELECT * FROM users WHERE username=:username", params, BeanPropertyRowMapper.newInstance(User.class));
    }
